"""
    Code for Inceptionv3 from Pytorch docs.
...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False,
                 inception_blocks=None, init_weights=None, in_channels=3):
        ...
        # change to work with variable in channels
